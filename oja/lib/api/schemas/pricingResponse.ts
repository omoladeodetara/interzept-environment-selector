 ...
 */
import type { PricingResponseVariant } from './pricingResponseVariant';
import type { PricingResponsePricing } from './pricingResponsePricing';

export interface PricingResponse {
  userId?: string;
  experimentId?: string;
  variant?: PricingResponseVariant;
  pricing?: PricingResponsePricing;
}
