...
export type GetApiTenantsTenantIdExperimentsStatus = typeof GetApiTenantsTenantIdExperimentsStatus[keyof typeof GetApiTenantsTenantIdExperimentsStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const GetApiTenantsTenantIdExperimentsStatus = {
  draft: 'draft',
  active: 'active',
  paused: 'paused',
  completed: 'completed',
