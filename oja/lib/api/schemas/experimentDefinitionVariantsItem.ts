 ...
 */
import type { ExperimentDefinitionVariantsItemMetadata } from './experimentDefinitionVariantsItemMetadata';

export type ExperimentDefinitionVariantsItem = {
  name?: string;
  price?: number;
  /**
   * @minimum 0
   ...
   */
  weight?: number;
  metadata?: ExperimentDefinitionVariantsItemMetadata;
};
