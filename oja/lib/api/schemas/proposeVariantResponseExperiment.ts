 ...
 */
import type { ProposeVariantResponseExperimentVariantsItem } from './proposeVariantResponseExperimentVariantsItem';

/**
 * Updated experiment details
 */
export type ProposeVariantResponseExperiment = {
  id?: string;
  key?: string;
  variants?: ProposeVariantResponseExperimentVariantsItem[];
};
