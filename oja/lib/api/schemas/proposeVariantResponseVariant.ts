 ...
 */
import type { ProposeVariantResponseVariantMetadata } from './proposeVariantResponseVariantMetadata';

/**
 * The newly proposed variant
 */
export type ProposeVariantResponseVariant = {
  name?: string;
  price?: number;
  weight?: number;
  metadata?: ProposeVariantResponseVariantMetadata;
};
