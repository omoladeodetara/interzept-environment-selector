 ...
 */
import type { GetApiTenantsTenantIdExperimentsStatus } from './getApiTenantsTenantIdExperimentsStatus';

export type GetApiTenantsTenantIdExperimentsParams = {
/**
 * Filter by experiment status
 */
status?: GetApiTenantsTenantIdExperimentsStatus;
};
